...
SELECT * FROM teams JOIN cities ON teams.city_id = cities.id WHERE cities.population_2013 < cities.population_2010 AND teams.conference = 'AFC';-- Select every city that has a team
